...
//        filterChainDefinitionMap.put("/imUser/**","anon");
//
...
//        shiroFilterFactoryBean.setFilterChainDefinitionMap(filterChainDefinitionMap);
        ...
        //动态读取shiro白名单列表  并设置忽略
        List<String> igoreUrlList = this.igoreUrlList.getUrls();
//        System.out.println(igoreUrlList);
        for(String url:igoreUrlList){
